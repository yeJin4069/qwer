					...
					<div className={ProductRegistrationCSS.productInfoDiv}>
						<div className={ProductRegistrationCSS.productImageDiv}>
							{productDetail && (
								<img
									className={
										ProductRegistrationCSS.productImage
									}
									src={
										imageUrl == null
							...
							<button
								className={
									ProductRegistrationCSS.productImageButton
								}
							...
							<tbody>
								<tr>
									...
									<td>
										<input
											...
											className={
												ProductRegistrationCSS.productInfoInput
											}
									...
									<td>
										<label>
											<input
												...
												checked={
													(!modifyMode
														? productDetail.productOrderable
														: form.productOrderable) ===
													'Y'
														? true
														: false
												}
								...
								<tr>
									...
									<td>
										<textarea
											className={
												ProductRegistrationCSS.textAreaStyle
											}
